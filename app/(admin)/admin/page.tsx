      ...
      <div className="w-full max-w-[450px] rounded-4xl border border-white/10 bg-white/5 p-12 shadow-2xl backdrop-blur-md">
        ...
        <div className="space-y-10">
          <div className="space-y-1">
            <label className="block text-[11px] font-bold tracking-[0.25em] text-white/50 uppercase">
              Kullanıcı Adı
            </label>
            <Input
              type="text"
          ...
          <Button className="w-full h-14 rounded-2xl bg-bej hover:bg-altin hover:text-white text-gray-800 font-bold tracking-[0.15em] uppercase transition-all duration-300 hover:cursor-pointer">
            Giriş Yap
          </Button>
        </div>
      </div>
